...
A modern, responsive web application built with SvelteKit 5 for tracking League of Legends Solo Queue performance. Search summoners across multiple regions, view detailed match history, add reflections from reviews and save profiles for quick access.
